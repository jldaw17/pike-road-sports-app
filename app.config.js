...
const VARIANT_CONFIGS = {
  ...
  sylacauga: {
    ...
    googleServicesFile: './assets/variants/sylacauga/google-services.json',
  ...
  wetumpka: {
    ...
    googleServicesFile: './assets/variants/wetumpka/google-services.json',
  ...
  prattville: {
    ...
    googleServicesFile: './assets/variants/prattville/google-services.json',
  ...
  campbell: {
    ...
    googleServicesFile: './assets/variants/campbell/google-services.json',
  ...
  fayetteville: {
    ...
    googleServicesFile: './assets/variants/fayetteville/google-services.json',
  ...
  childersburg: {
    ...
    googleServicesFile: './assets/variants/childersburg/google-services.json',
